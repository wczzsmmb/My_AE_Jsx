...
if (comp == null || !(comp instanceof CompItem)) {
    ...
    if (layer == null || !(layer instanceof ShapeLayer)) {
        ...
        // 除以 0.7 并乘以 0.01
        var adjustedLength = (totalLength / 0.7) * 0.01;

        // 调整后的路径长度
        alert("调整后的路径长度为: " + adjustedLength.toFixed(2) + " 像素");

        // 第二步：根据调整后的长度来移动时间线帧数
        // 获取当前合成
        var framesToMove = Math.ceil(adjustedLength * 60);  // 路径长度乘以60后，向上取整
